...
class TeacherAdapter(context: Context, teacherClassModelList: List<TeacherClassModel>):
    ...
    override fun onBindViewHolder(holder: TeacherViewHolder, position: Int) {
        ...
        holder.listItem.setOnClickListener {
            ...
            intent.putExtra("classId",teacherClassModel.getUniqueId())
            intent.putExtra("teacherId", teacherClassModel.getUserId())
        ...
        holder.ivmenu.setOnClickListener {
            ...
            popupMenu.setOnMenuItemClickListener {item ->
                if(item.itemId == R.id.sendInviteMenu)
                    sendToGoogleMail(teacherClassModel.getTitle(), teacherClassModel.getUserId(), teacherClassModel.getUniqueId())
    ...
    private fun sendToGoogleMail(className: String, teacherId: String, codeToJoin: String) {
